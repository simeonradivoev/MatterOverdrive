...
public interface IBioticStat
{
    ...
    /**
     * Called when the Ability is unlearned by the player.
     * Used mainly to reset changed stuff.
     * @param androidPlayer the android player.
     ...
     * Compared to {@link IBioticStat#onAndroidUpdate(AndroidPlayer, int)} which is called ONLY if the stat IS unlocked.
     * @param androidPlayer
     * @param level
     * @param enabled
     */
    ...
    /**
     * Is the Bionic stat Enabled. This will display it Red if disabled and will not call {@link IBioticStat#onAndroidUpdate(AndroidPlayer, int)}.
     * @param android The Android Player
     * @param level The unlocked stat level
