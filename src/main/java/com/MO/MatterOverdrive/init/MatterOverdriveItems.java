...
public class MatterOverdriveItems 
{
    ...
    public static Isolinear_circut isolinear_circut;
	...
	public static void init()
	{
        ...
        isolinear_circut = new Isolinear_circut("isolinear_circut");
	...
	public static void register()
	{
		...
		GameRegistry.addRecipe(new ItemStack(matter_scanner), new Object[]{"III","GDG","IRI", 'I',Items.iron_ingot, 'D',new ItemStack(isolinear_circut,1,2),'R',Items.redstone,'G',Items.gold_ingot});
        GameRegistry.addRecipe(new ItemStack(base_upgrade),new Object[]{" R "," C "," T ",'G', Blocks.glass,'R',Items.redstone,'T',tritanium_plate,'C',new ItemStack(isolinear_circut,1,0)});
        GameRegistry.addRecipe(new ItemStack(h_compensator),new Object[]{" M ","CPC","DED",'D', MatterOverdriveItems.dilithium_ctystal,'M',machine_casing,'I',Items.iron_ingot,'C',new ItemStack(isolinear_circut,1,0),'P',new ItemStack(isolinear_circut,1,1),'E',Items.ender_pearl});
        GameRegistry.addRecipe(new ItemStack(integration_matrix),new Object[]{" M ","GPG","DED",'G', Blocks.glass,'M',machine_casing,'I',Items.iron_ingot,'P',new ItemStack(isolinear_circut,1,1),'E',Items.ender_pearl,'D',MatterOverdriveItems.dilithium_ctystal});
        ...
        GameRegistry.addRecipe(new ItemStack(me_conversion_matrix),new Object[]{"EIE","CDC","EIE",'E',Items.ender_pearl,'C',new ItemStack(isolinear_circut,1,1),'I',Items.iron_ingot,'D',MatterOverdriveItems.dilithium_ctystal});
        GameRegistry.addRecipe(new ItemStack(tritanium_plate),new Object[]{"TTT",'T',new ItemStack(tritanium_ingot)});
        GameRegistry.addRecipe(new ItemStack(phaser),new Object[]{"IGI","IDI","WCW",'I',Items.iron_ingot,'G',Blocks.glass,'D',dilithium_ctystal,'W',Blocks.wool,'C',new ItemStack(isolinear_circut,1,1)});
