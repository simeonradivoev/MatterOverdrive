...
public class MatterOverdriveBlocks 
{
	...
	public static void register()
	{
        ...
        GameRegistry.addRecipe(new ItemStack(decomposer), new Object[]{"OCO","IMI","ONO",'O',Blocks.iron_block,'C',new ItemStack(MatterOverdriveItems.isolinear_circut,1,2),'M',MatterOverdriveItems.me_conversion_matrix,'N',MatterOverdriveItems.integration_matrix,'I',Items.iron_ingot});
		GameRegistry.addRecipe(new ItemStack(replicator), new Object[]{"OCO","IMI","OHO",'O',Blocks.iron_block,'C',new ItemStack(MatterOverdriveItems.isolinear_circut,1,2),'M',MatterOverdriveItems.me_conversion_matrix,'H',MatterOverdriveItems.h_compensator,'I',Items.iron_ingot});
        GameRegistry.addRecipe(new ItemStack(network_controller), new Object[]{"IGI","CDC","OMO",'M',MatterOverdriveItems.machine_casing,'C',new ItemStack(MatterOverdriveItems.isolinear_circut,1,0),'D',new ItemStack(MatterOverdriveItems.isolinear_circut,1,2),'I',Items.iron_ingot,'G',Blocks.glass});
        ...
        GameRegistry.addRecipe(new ItemStack(network_pipe,4), new Object[]{"IGI","BCB","IGI",'M',MatterOverdriveItems.s_magnet,'G',Blocks.glass,'I',Items.iron_ingot,'B',Items.gold_ingot,'C',new ItemStack(MatterOverdriveItems.isolinear_circut,1,0)});
        GameRegistry.addRecipe(new ItemStack(matter_analyzer),new Object[]{" C ","IMI","ONO",'O',Blocks.iron_block,'C',new ItemStack(MatterOverdriveItems.isolinear_circut,1,2),'M',MatterOverdriveItems.me_conversion_matrix,'N',MatterOverdriveItems.integration_matrix,'I',Items.iron_ingot});
